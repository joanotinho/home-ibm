            ...
            <div class="tabs-contents">
                <form id="form" action="{{route("products_categories_store")}}" class="admin-form">
                    <div class="tab-content active" data-tab-content="content">
                        ...
                        <input type="hidden" name="id" value="{{isset($productsCategory->id) ? $productsCategory->id : ''}}" class="user-id">
                        ...
                        <div class="desktop-two-columns">
                            <div class="column">
                                <div class="field">
                                    ...
                                    <div class="field-input">
                                        <input type="text" name="name" id="name" data-type="name" class="counter-input" data-max-length="64" autocomplete="off" value="{{isset($productsCategory->name) ? $productsCategory->name : ''}}">
                                    </div>
                            ...
                            <div class="column">
                                ...
                                <div class="field">
                                    ...
                                    <div class="field-input">
                                        <input type="text" name="title" id="title" data-type="title" data-max-length="255" class="counter-input" value="{{isset($productsCategory->title) ? $productsCategory->title : ''}}">
                                    </div>
