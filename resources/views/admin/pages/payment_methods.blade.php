        ...
        <div class="nested-sort-container">
            ...
            <div class="nested-sort">
                @if(isset($payment_methods))
                    @foreach ($payment_methods as $payment_method_element)
                        <div class="nested-sort-item" data-id="{{$payment_method_element->id}}">
                                        ...
                                        <div class="user">
                                            <div class="user-left">
                                                ...
                                                <div class="field">
                                                    ...
                                                    <div class="value">
                                                        <span>{{$payment_method_element->name}}</span>
                                                    </div>
                                                </div>
                                                <div class="field">
                                                    <div class="description">
                                                    ...
                                                    <div class="value">
                                                        <span>{{$payment_method_element->created_at}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="user-right">
                                                <div class="tooltip-container">
                                                    ...
                                                    <div class="edit-user-button" data-url="{{route('payment_methods_edit', ['payment_method' => $payment_method_element->id])}}">
                                                ...
                                                <div class="tooltip-container">
                                                    ...
                                                    <div class="delete-user-button" data-url="{{route('payment_methods_destroy', ['payment_method' => $payment_method_element->id])}}">
                                                        <svg viewBox="0 0 24 24">
    ...
    <div class="editor">
        <div class="tabs-container">
                ...
                <div class="form-buttons">
                    ...
                    <div class="form-button">
                        <div class="tooltip-container">
                            ...
                            <div class="clean-button" data-url="{{route('payment_methods_create')}}">
                                <svg viewBox="0 0 24 24">
            ...
            <div class="tabs-contents">
                <form id="form" action="{{route("payment_methods_store")}}" class="admin-form">
                    <div class="tab-content active" data-tab-content="content">
                        {{ csrf_field() }}
                        
                        <input autocomplete="false" name="hidden" type="text" style="display:none;">
                        <input type="hidden" name="id" value="{{isset($payment_method->id) ? $payment_method->id : ''}}" class="user-id">
                        ...
                        <div class="desktop-two-columns">
                            <div class="column">
                                <div class="field">
                                    ...
                                    <div class="field-input">
                                        <input type="text" name="name" id="name" data-type="name" class="counter-input" data-max-length="64" autocomplete="off" value="{{isset($payment_method->name) ? $payment_method->name : ''}}">
                                    </div>
                            ...
                            <div class="column">
                                ...
                                <div class="field">
                                    ...
                                    <div class="field-input">
                                        <input type="text" name="title" id="title" data-type="title" data-max-length="255" class="counter-input" value="{{isset($payment_method->title) ? $payment_method->title : ''}}">
                                    </div>
