        ...
        <div class="nested-sort-container">
            ...
            <div class="nested-sort">
                @foreach ($contacts as $contact_element)
                    <div class="nested-sort-item" data-id="{{$contact_element->id}}">
                                    ...
                                    <div class="user">
                                        <div class="user-left">
                                            <div class="field">
                                                ...
                                                <div class="value">
                                                    <span>{{$contact_element->name}}</span>
                                                </div>
                                            </div>
                                            <div class="field">
                                                <div class="description">
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="value">
                                                    <span>{{$contact_element->created_at}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="user-right">
                                            <div class="tooltip-container">
                                                ...
                                                <div class="edit-user-button" data-url="{{route('contacts_edit', ['contact' => $contact_element->id])}}">
                                            ...
                                            <div class="tooltip-container">
                                                ...
                                                <div class="delete-user-button" data-url="{{route('contacts_destroy', ['contact' => $contact_element->id])}}">
                                                    <svg viewBox="0 0 24 24">
    ...
    <div class="editor">
        <div class="tabs-container">
                ...
                <div class="form-buttons">
                    ...
                    <div class="form-button">
                        <div class="tooltip-container">
                            ...
                            <div class="clean-button" data-url="{{route('contacts_create')}}">
                                <svg viewBox="0 0 24 24">
            ...
            <div class="tabs-contents">
                <form id="form" action="{{route("contacts_store")}}" class="admin-form">
                    <div class="tab-content active" data-tab-content="content">
                        {{ csrf_field() }}
                        
                        <input autocomplete="false" name="hidden" type="text" style="display:none;">
                        <input type="hidden" name="id" value="{{isset($contact->id) ? $contact->id : ''}}" class="user-id">
                        ...
                        <div class="desktop-two-columns">
                            <div class="column">
                                <div class="field">
                                    ...
                                    <div class="field-input">
                                        <input type="text" name="name" id="name" data-type="name" class="counter-input" data-max-length="64" autocomplete="off" value="{{isset($contact->name) ? $contact->name : ''}}">
                                    </div>
                            ...
                            <div class="column">
                                ...
                                <div class="field">
                                    ...
                                    <div class="field-input">
                                        <input type="text" name="surnames" id="email" data-type="surnames" data-max-length="255" class="counter-input" value="{{isset($contact->surnames) ? $contact->surnames : ''}}">
                                    </div>
                                    
                                    <div class="field-rule">
                                        <span>Los apellidos no pueden estar vacío</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="desktop-single-column">
                            ...
                            <div class="column">
                                ...
                                <div class="field">
                                    ...
                                    <div class="field-input">
                                        <input type="number" name="email" id="email" data-type="email" data-max-length="255" class="counter-input" value="{{isset($contact->email) ? $contact->email : ''}}">
                                    </div>
                        ...
                        <div class="desktop-single-column">
                            <div class="column">
                                ...
                                <div class="field-input">
                                    <textarea name="description" class="ckeditor" value="{{isset($contact->description) ? $contact->description : ''}}"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
