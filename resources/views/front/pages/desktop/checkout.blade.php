    ...
    <div class="checkout-container">
                        ...
                        <div class="checkout-right-main">
                            ...
                            <div class="payment-methods">
                                <div class="desktop-two-columns">
                                    <div class="column">
                                        <div class="payment-method mobile-single-column">
                                            <div class="column">
        ...
        <!-- <form enctype="multipart/form-data" class="front-form" id="checkout-form">
            ...
            <div class="desktop-two-columns">
                ...
                <div class="column">
                    <label for="surnames">Apellidos:</label>
                    <input type="text" name="surnames" id="surnames" class="required">
                </div>
            </div>
            <div class="desktop-two-columns">
                <div class="column">
                ...
                <div class="column">
                    ...
                    <input type="text" name="phonenumber" id="phonenumber" class="required">
                </div>
            </div>
